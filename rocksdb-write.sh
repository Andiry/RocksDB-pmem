...
./db_bench --db=/mnt/ramdisk/rocksdb --num_levels=6 --key_size=20 --prefix_size=20 \
     ...
     --max_bytes_for_level_base=1073741824 --disable_wal=0 --wal_dir=/mnt/ramdisk/rocksdb/WAL_LOG \
